...
/* =======================================================
    ...
    $langlist.find("a").on("click",function(){
        $input.val($(this).text()); //언어 선택 시 입력상자의 내용 변경
        // .val() : 입력요소에 있는 value 속성값을 불러오거나 변경 시 사용
        // 변경 시엔 () 안에 새 값 입력
...
========================================================== */ 
    ...
    // 메인 메뉴 - scroll 이벤트와 scrollTop()을 이용한 원페이지 구현 
...
// 5단계 - 모바일 본문 내용 변경 할 요소 변수지정 및 새 요소 교체
    ...
    // 햄버거버튼
        ...
        // .toggle() : 선택한 요소가 보이면 숨기고, 숨겨져있으면 나타나도록 만듦.
